...
namespace cl
{
    ...
    public:
        ...
        {
            return size_for(
                static_cast<size_t>(backing->value_cell_count.get_smi()));
        }
        ...
        Value value_cell_count;
        Value elements[1];

        CL_DECLARE_DYNAMIC_SMI_VALUE_SPAN(ValueArrayBacking, value_cell_count,
                                          elements, 0);
    ...
    public:
        ...
        CL_DECLARE_DYNAMIC_SMI_VALUE_SPAN(HeapPtrArrayBacking, value_cell_count,
                                          elements, 0);
