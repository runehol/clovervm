...
| Status | Accepted |
| Implementation | Slices 1 through 4 complete: result-definition metadata, block-local forwarding live ranges, verification, location publication, guard declarations, AArch64 constraints, and zero-code guard result emission are implemented |
