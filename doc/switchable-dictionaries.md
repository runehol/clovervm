...
cache-bearing hash and equality sites. The remaining major work is the
deliberately deferred mapping-method compatibility and final cleanup. The
semantic C API is available, and the bootstrap `GeneralDict` has been removed.
