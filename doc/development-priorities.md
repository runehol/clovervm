...
7. **Inner functions with variable capture**
...
8. **Remaining operator and expression surface**
...
11. **Slice write/delete support when it becomes the shortest path**
