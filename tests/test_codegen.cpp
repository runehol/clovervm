...
TEST(Codegen, direct_range_for_loop_uses_specialized_fast_path_with_fallback)
{
    std::string expected =
        ...
        "   38 Ldar1\n"
        "   39 Star4\n"
        "   40 CallPositional r0, {r4:1}, call_ic[0]\n"
        "   45 Star4\n"
        "   46 CallSpecialMethod r4, c[3], read_ic[0], call_ic[1], 0, c[4], "
        "c[5]\n"
        "   54 Star2\n"
        "   55 Ldar2\n"
        "   56 Star4\n"
        "   57 CallSpecialMethod r4, c[6], read_ic[1], call_ic[2], 0, c[4], "
        "c[7]\n"
        ...
        "   75 Add r3\n"
        "   77 StaGlobal c[0], module_global_mutation_ic[4]\n"
        "   80 Jump 55\n"
        "   83 LdaConstant c[8]\n"
        "   85 ActiveExceptionIsInstance\n"
        "   86 JumpIfFalse 93\n"
        "   89 ClearActiveException\n"
        "   90 Jump 94\n"
        "   93 ReraiseActiveException\n"
        "   94 LdaGlobal c[0], module_global_read_ic[5]\n"
        "   97 Return\n"
        "Exception table:\n"
        "    57..65 -> 83\n"
        "Constant 0: \"total\"\n"
...
TEST(Codegen, non_direct_for_loop_uses_generic_iterator_protocol_calls)
{
    std::string expected =
        ...
        "   28 Ldar0\n"
        "   29 Star2\n"
        "   30 CallSpecialMethod r2, c[5], read_ic[1], call_ic[2], 0, c[3], "
        "c[6]\n"
        "   38 StaGlobal c[8], module_global_mutation_ic[1]\n"
        "   41 LdaGlobal c[8], module_global_read_ic[2]\n"
        "   44 Jump 28\n"
        "   47 LdaConstant c[7]\n"
        "   49 ActiveExceptionIsInstance\n"
        "   50 JumpIfFalse 57\n"
        "   53 ClearActiveException\n"
        "   54 Jump 58\n"
        "   57 ReraiseActiveException\n"
        "   58 Return\n"
        "Exception table:\n"
        "    30..38 -> 47\n"
        "Constant 0: \"range\"\n"
