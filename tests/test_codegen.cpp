...
TEST(Codegen, direct_keyword_method_call_uses_callmethodattrkeyword)
{
    ...
    std::string expected =
        ...
        "    6 LdaSmi 3\n"
        "    8 Star0\n"
        "    9 CallMethodAttrKeyword r2, c[0], read_ic[0], "
        "keyword_call_ic[0], "
...
TEST(Codegen, direct_range_for_loop_uses_specialized_fast_path_with_fallback)
{
    std::string expected =
        ...
        "   48 Star4\n"
        "   49 CallSpecialMethod0 r4, c[3], operator_ic[1], c[4], c[5]\n"
        "   55 Star2\n"
        "   56 Mov r4, r2\n"
        "   59 CallSpecialMethod0 r4, c[6], operator_ic[2], c[4], c[7]\n"
        "   65 StaGlobal c[2], module_global_mutation_ic[3]\n"
        "   68 LdaGlobal c[0], module_global_read_ic[3]\n"
        "   71 Star3\n"
        "   72 LdaGlobal c[2], module_global_read_ic[4]\n"
        "   75 Add r3, operator_ic[3]\n"
        "   79 StaGlobal c[0], module_global_mutation_ic[4]\n"
        "   82 Jump 56\n"
        "   85 LdaConstant c[8]\n"
        "   87 ActiveExceptionIsInstance\n"
        "   88 JumpIfFalse 95\n"
        "   91 ClearActiveException\n"
        "   92 Jump 96\n"
        "   95 ReraiseActiveException\n"
        "   96 LdaGlobal c[0], module_global_read_ic[5]\n"
        "   99 Return\n"
        "Exception table:\n"
        "    59..65 -> 85\n"
        "Constant 0: \"total\"\n"
...
TEST(Codegen, non_direct_for_loop_uses_generic_iterator_protocol_calls)
{
    std::string expected =
        ...
        "   18 Star2\n"
        "   19 CallSpecialMethod0 r2, c[2], operator_ic[0], c[3], c[4]\n"
        "   25 Star0\n"
        "   26 Mov r2, r0\n"
        "   29 CallSpecialMethod0 r2, c[5], operator_ic[1], c[3], c[6]\n"
        "   35 StaGlobal c[8], module_global_mutation_ic[1]\n"
        "   38 LdaGlobal c[8], module_global_read_ic[2]\n"
        "   41 Jump 26\n"
        "   44 LdaConstant c[7]\n"
        "   46 ActiveExceptionIsInstance\n"
        "   47 JumpIfFalse 54\n"
        "   50 ClearActiveException\n"
        "   51 Jump 55\n"
        "   54 ReraiseActiveException\n"
        "   55 Return\n"
        "Exception table:\n"
        "    29..35 -> 44\n"
        "Constant 0: \"range\"\n"
...
TEST(Codegen, trusted_clover_call_special_encodes_arity_in_opcode)
{
    std::string actual = trusted_builtin_bytecode_str_from_file(
        L"def call0(obj):\n"
        L"    __clover_call_special__(obj, \"m0\", TypeError, \"missing\")\n"
        L"def call1(obj, a):\n"
        L"    __clover_call_special__(obj, \"m1\", TypeError, \"missing\", a)\n"
        L"def call2(obj, a, b):\n"
        L"    __clover_call_special__(obj, \"m2\", TypeError, \"missing\", a, "
        L"b)\n"
        L"def call3(obj, a, b, c):\n"
        L"    __clover_call_special__(obj, \"m3\", TypeError, \"missing\", a, "
        L"b, c)\n");

    EXPECT_NE(std::string::npos, actual.find("CallSpecialMethod0"));
    EXPECT_NE(std::string::npos, actual.find("CallSpecialMethod1"));
    EXPECT_NE(std::string::npos, actual.find("CallSpecialMethod2"));
    EXPECT_NE(std::string::npos, actual.find("CallSpecialMethod3"));
}
