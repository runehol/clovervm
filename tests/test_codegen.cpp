...
TEST(Codegen, direct_range_for_loop_uses_specialized_fast_path_with_fallback)
{
    std::string expected = "Code object:\n"
                           ...
                           "   58 GetIter\n"
                           "   59 Star a0\n"
                           "   61 CallSpecialMethod a0, c[0], special_ic[0], "
                           "call_ic[1], 0\n"
                           "   67 Star2\n"
                           "   68 Ldar2\n"
                           "   69 Star a0\n"
                           "   71 CallSpecialMethod a0, c[1], special_ic[1], "
                           "call_ic[2], 0\n"
                           "   77 StaGlobal [2]\n"
                           "   82 LdaGlobal [0]\n"
                           "   87 Star3\n"
                           ...
                           "  100 Jump 68\n"
                           "  103 LdaConstant c[2]\n"
                           "  105 ActiveExceptionIsInstance\n"
                           "  106 JumpIfFalse 113\n"
                           "  109 ClearActiveException\n"
                           "  110 Jump 114\n"
                           "  113 ReraiseActiveException\n"
                           "  114 LdaGlobal [0]\n"
                           "  119 Return\n"
                           "Exception table:\n"
                           "    71..77 -> 103\n"
...
TEST(Codegen, non_direct_for_loop_still_uses_generic_iterator_bytecodes)
{
    std::string expected = "Code object:\n"
                           ...
                           "   25 GetIter\n"
                           "   26 Star a0\n"
                           "   28 CallSpecialMethod a0, c[0], special_ic[0], "
                           "call_ic[1], 0\n"
                           "   34 Star0\n"
                           "   35 Ldar0\n"
                           "   36 Star a0\n"
                           "   38 CallSpecialMethod a0, c[1], special_ic[1], "
                           "call_ic[2], 0\n"
                           "   44 StaGlobal [2]\n"
                           "   49 LdaGlobal [2]\n"
                           "   54 Jump 35\n"
                           "   57 LdaConstant c[2]\n"
                           "   59 ActiveExceptionIsInstance\n"
                           "   60 JumpIfFalse 67\n"
                           "   63 ClearActiveException\n"
                           "   64 Jump 68\n"
                           "   67 ReraiseActiveException\n"
                           "   68 Return\n"
                           "Exception table:\n"
                           "    38..44 -> 57\n"
                           "Constant 0: \"__iter__\"\n"
