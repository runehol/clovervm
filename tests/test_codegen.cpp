...
TEST(Codegen, subscript_store_uses_receiver_key_regs_and_accumulator_value)
{
    ...
    std::string expected =
        ...
        "Constant 0: Code object:\n"
        "    0 Ldar p2\n"
        "    2 StoreSubscript p0, p1, subscript_ic[0]\n"
        "    6 LdaNone\n"
        "    7 Return\n"
        "\n"
        "Constant 1: \"set\"\n";
...
TEST(Codegen, subscript_delete_uses_receiver_and_key_regs)
{
    ...
    std::string expected =
        ...
        "    5 Return\n"
        "Constant 0: Code object:\n"
        "    0 DelSubscript p0, p1, subscript_ic[0]\n"
        "    4 LdaNone\n"
        "    5 Return\n"
        "\n"
        "Constant 1: \"clear\"\n";
...
TEST(Codegen, subscript_augmented_assignment_evaluates_receiver_and_key_once)
{
    ...
    std::string expected =
        ...
        "    2 LoadSubscript p0, subscript_ic[0]\n"
        "    5 AddSmi 1\n"
        "    7 StoreSubscript p0, p1, subscript_ic[1]\n"
        "   11 LdaNone\n"
        "   12 Return\n"
        "\n"
        "Constant 1: \"bump\"\n";
...
TEST(Codegen, direct_range_for_loop_uses_specialized_fast_path_with_fallback)
{
    std::string expected =
        ...
        "   35 Jump 16\n"
        "   38 Mov r4, r1\n"
        "   41 CallPositional r0, {r4:1}, call_ic[0]\n"
        "   46 Star4\n"
        "   47 CallSpecialMethod r4, c[3], read_ic[0], call_ic[1], 0, c[4], "
        "c[5]\n"
        "   55 Star2\n"
        "   56 Mov r4, r2\n"
        "   59 CallSpecialMethod r4, c[6], read_ic[1], call_ic[2], 0, c[4], "
        "c[7]\n"
        "   67 StaGlobal c[2], module_global_mutation_ic[3]\n"
        "   70 LdaGlobal c[0], module_global_read_ic[3]\n"
        "   73 Star3\n"
        "   74 LdaGlobal c[2], module_global_read_ic[4]\n"
        "   77 Add r3\n"
