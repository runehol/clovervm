...
TEST(Parser, try_typed_except_stmt)
{
    std::string expected = ("try:\n"
                            "    risky()\n"
                            "except NameError:\n"
...
TEST(Parser, try_typed_except_as_stmt)
{
    std::string expected = ("try:\n"
                            "    risky()\n"
...
TEST(Parser, try_except_finally_stmt)
{
    std::string expected = ("try:\n"
                            "    risky()\n"
                            "except NameError:\n"
...
TEST(Parser, string_literal_decodes_escapes_and_prefixes)
{
    ...
    EXPECT_STREQ(L"☺", string_as_wchar_t(TValue<String>::from_value_checked(
